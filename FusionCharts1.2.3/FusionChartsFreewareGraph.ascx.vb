...
Partial Public Class FusionChartsFreewareGraph
	Inherits BaseGraph
	...
	Private Sub Chart1_DrillDownEvent(ByVal sender As FusionChartsFreeware.Chart, ByVal row As System.Data.DataRow, ByVal columnName As String, ByVal columnValue As String) Handles Chart1.DrillDownEvent
		doDrilldown(row)
	End Sub
